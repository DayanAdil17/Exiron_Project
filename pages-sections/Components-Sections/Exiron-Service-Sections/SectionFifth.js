...
export default function SectionFifth() {
  ...
  return (
    <div ref = {ref}>
        <div className={classes.sections}  style={{backgroundImage:"url('/exironImg/sgn4.jpg')", backgroundRepeat:'no-repeat', backgroundSize:'cover'}}>
                    ...
                    <GridItem xs = {12} sm = {6} md = {6}>
                        <div className={classes.container}>   
                            <div className={classes.title}>                     
                                ...
                                <h4 className={classes.subtitle} style = {{color:"#ffffff", color:"#ffffff"}}>
                    ...
                    <GridItem xs = {12} sm = {6} md = {6}>
                        ...
                        >                            
                            <CardMedia
                                ...
                                image="/exironImg/Resize_automotive-industry.webp"
                                title="Automotive"
                                style={{
